这是一个本地的笔记本，可以在一个页面中实现对于pdf，markdown等文件的浏览和批注记笔记，以及分块整理，同时设计了初步的复习机制，监测上次打开时间来提醒定定时复习，目的是想解决学了就扔的坏毛病


下面是ai的总结，这是一个vibe coding的作品，还有很多的东西可以添加上，属于是个半成品，未来要调整前端的布局，加上更多有关批注和方便复习的小功能，但是可能都是丢给ai几句话就可以搞定了
